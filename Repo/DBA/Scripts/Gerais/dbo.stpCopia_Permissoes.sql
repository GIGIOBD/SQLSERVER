/*
exec dbo.stpCopia_Permissoes 
@Usuario_Origem			= 'I4PROINFO\aasilva',
@Usuario_Destino		= 'I4PROINFO\azago',
@Database				= 'senac_prev_cli',
@Fl_Remover_Permissoes	= 0,
@Fl_Cria_Usuarios		= 0,
@Fl_Exibe_Resultados	= 1,
@Fl_Executar			= 0
*/
