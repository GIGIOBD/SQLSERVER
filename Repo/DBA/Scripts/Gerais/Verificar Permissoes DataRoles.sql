-- Query com busca ao usu�rio W3$GWMAP' apresentando o result 
-- para posterior execu��o (RESULT TO TEXT - NO GRID)
...
WHERE dp.name IN ('db_cria_objetos')
ORDER BY dp.name, schema_id, o.NAME


/*
--Listar quais permiss�es cada usu�rio tem
--dentro do database
SELECT
