...
LEFT JOIN sys.types   AS T
 ...
 ORDER BY   GeneralSchema
   ...
   SELECT Z.GeneralID
		...
		+ MAX(CASE WHEN Z.regular_column_id = 20 THEN ', [' + Z.GeneralColumn + ']' + CASE WHEN Z.is_descending_key != 0 THEN ' DESC' ELSE SPACE(0) END ELSE SPACE(0) END)
		+ MAX(CASE WHEN Z.regular_column_id = 21 THEN ', [' + Z.GeneralColumn + ']' + CASE WHEN Z.is_descending_key != 0 THEN ' DESC' ELSE SPACE(0) END ELSE SPACE(0) END)
		+ MAX(CASE WHEN Z.regular_column_id = 22 THEN ', [' + Z.GeneralColumn + ']' + CASE WHEN Z.is_descending_key != 0 THEN ' DESC' ELSE SPACE(0) END ELSE SPACE(0) END)
		+ MAX(CASE WHEN Z.regular_column_id = 23 THEN ', [' + Z.GeneralColumn + ']' + CASE WHEN Z.is_descending_key != 0 THEN ' DESC' ELSE SPACE(0) END ELSE SPACE(0) END)
		+ MAX(CASE WHEN Z.regular_column_id = 24 THEN ', [' + Z.GeneralColumn + ']' + CASE WHEN Z.is_descending_key != 0 THEN ' DESC' ELSE SPACE(0) END ELSE SPACE(0) END)
		+ MAX(CASE WHEN Z.regular_column_id = 25 THEN ', [' + Z.GeneralColumn + ']' + CASE WHEN Z.is_descending_key != 0 THEN ' DESC' ELSE SPACE(0) END ELSE SPACE(0) END)
		+ MAX(CASE WHEN Z.regular_column_id = 26 THEN ', [' + Z.GeneralColumn + ']' + CASE WHEN Z.is_descending_key != 0 THEN ' DESC' ELSE SPACE(0) END ELSE SPACE(0) END)
		+ MAX(CASE WHEN Z.regular_column_id = 27 THEN ', [' + Z.GeneralColumn + ']' + CASE WHEN Z.is_descending_key != 0 THEN ' DESC' ELSE SPACE(0) END ELSE SPACE(0) END)
		+ MAX(CASE WHEN Z.regular_column_id = 28 THEN ', [' + Z.GeneralColumn + ']' + CASE WHEN Z.is_descending_key != 0 THEN ' DESC' ELSE SPACE(0) END ELSE SPACE(0) END)
		+ MAX(CASE WHEN Z.regular_column_id = 29 THEN ', [' + Z.GeneralColumn + ']' + CASE WHEN Z.is_descending_key != 0 THEN ' DESC' ELSE SPACE(0) END ELSE SPACE(0) END)
		+ MAX(CASE WHEN Z.regular_column_id = 30 THEN ', [' + Z.GeneralColumn + ']' + CASE WHEN Z.is_descending_key != 0 THEN ' DESC' ELSE SPACE(0) END ELSE SPACE(0) END)
		+ MAX(CASE WHEN Z.regular_column_id = 31 THEN ', [' + Z.GeneralColumn + ']' + CASE WHEN Z.is_descending_key != 0 THEN ' DESC' ELSE SPACE(0) END ELSE SPACE(0) END)
		+ MAX(CASE WHEN Z.regular_column_id = 32 THEN ', [' + Z.GeneralColumn + ']' + CASE WHEN Z.is_descending_key != 0 THEN ' DESC' ELSE SPACE(0) END ELSE SPACE(0) END)
		+ MAX(CASE WHEN Z.regular_column_id = 33 THEN ', [' + Z.GeneralColumn + ']' + CASE WHEN Z.is_descending_key != 0 THEN ' DESC' ELSE SPACE(0) END ELSE SPACE(0) END)
		+ MAX(CASE WHEN Z.regular_column_id = 34 THEN ', [' + Z.GeneralColumn + ']' + CASE WHEN Z.is_descending_key != 0 THEN ' DESC' ELSE SPACE(0) END ELSE SPACE(0) END)
		+ MAX(CASE WHEN Z.regular_column_id = 35 THEN ', [' + Z.GeneralColumn + ']' + CASE WHEN Z.is_descending_key != 0 THEN ' DESC' ELSE SPACE(0) END ELSE SPACE(0) END)
		+ MAX(CASE WHEN Z.regular_column_id = 36 THEN ', [' + Z.GeneralColumn + ']' + CASE WHEN Z.is_descending_key != 0 THEN ' DESC' ELSE SPACE(0) END ELSE SPACE(0) END)
		+ MAX(CASE WHEN Z.regular_column_id = 37 THEN ', [' + Z.GeneralColumn + ']' + CASE WHEN Z.is_descending_key != 0 THEN ' DESC' ELSE SPACE(0) END ELSE SPACE(0) END)
		+ MAX(CASE WHEN Z.regular_column_id = 38 THEN ', [' + Z.GeneralColumn + ']' + CASE WHEN Z.is_descending_key != 0 THEN ' DESC' ELSE SPACE(0) END ELSE SPACE(0) END)
		+ MAX(CASE WHEN Z.regular_column_id = 39 THEN ', [' + Z.GeneralColumn + ']' + CASE WHEN Z.is_descending_key != 0 THEN ' DESC' ELSE SPACE(0) END ELSE SPACE(0) END)
		+ MAX(CASE WHEN Z.regular_column_id = 40 THEN ', [' + Z.GeneralColumn + ']' + CASE WHEN Z.is_descending_key != 0 THEN ' DESC' ELSE SPACE(0) END ELSE SPACE(0) END)
		+ MAX(CASE WHEN Z.regular_column_id = 41 THEN ', [' + Z.GeneralColumn + ']' + CASE WHEN Z.is_descending_key != 0 THEN ' DESC' ELSE SPACE(0) END ELSE SPACE(0) END)
		+ MAX(CASE WHEN Z.regular_column_id = 42 THEN ', [' + Z.GeneralColumn + ']' + CASE WHEN Z.is_descending_key != 0 THEN ' DESC' ELSE SPACE(0) END ELSE SPACE(0) END)
		+ MAX(CASE WHEN Z.regular_column_id = 43 THEN ', [' + Z.GeneralColumn + ']' + CASE WHEN Z.is_descending_key != 0 THEN ' DESC' ELSE SPACE(0) END ELSE SPACE(0) END)
		+ MAX(CASE WHEN Z.regular_column_id = 44 THEN ', [' + Z.GeneralColumn + ']' + CASE WHEN Z.is_descending_key != 0 THEN ' DESC' ELSE SPACE(0) END ELSE SPACE(0) END)
		+ MAX(CASE WHEN Z.regular_column_id = 45 THEN ', [' + Z.GeneralColumn + ']' + CASE WHEN Z.is_descending_key != 0 THEN ' DESC' ELSE SPACE(0) END ELSE SPACE(0) END)
		+ MAX(CASE WHEN Z.regular_column_id = 46 THEN ', [' + Z.GeneralColumn + ']' + CASE WHEN Z.is_descending_key != 0 THEN ' DESC' ELSE SPACE(0) END ELSE SPACE(0) END)
        + MAX(CASE WHEN Z.regular_column_id > 46 THEN ', [...]'                                                                                         ELSE SPACE(0) END) AS RegularColumn
		...
		+ MAX(CASE WHEN Z.include_column_id = 20 THEN ', [' + Z.GeneralColumn + ']'                                                                     ELSE SPACE(0) END)
		+ MAX(CASE WHEN Z.include_column_id = 21 THEN ', [' + Z.GeneralColumn + ']'                                                                     ELSE SPACE(0) END)
		+ MAX(CASE WHEN Z.include_column_id = 22 THEN ', [' + Z.GeneralColumn + ']'                                                                     ELSE SPACE(0) END)
		+ MAX(CASE WHEN Z.include_column_id = 23 THEN ', [' + Z.GeneralColumn + ']'                                                                     ELSE SPACE(0) END)
		+ MAX(CASE WHEN Z.include_column_id = 24 THEN ', [' + Z.GeneralColumn + ']'                                                                     ELSE SPACE(0) END)
		+ MAX(CASE WHEN Z.include_column_id = 25 THEN ', [' + Z.GeneralColumn + ']'                                                                     ELSE SPACE(0) END)
		+ MAX(CASE WHEN Z.include_column_id = 26 THEN ', [' + Z.GeneralColumn + ']'                                                                     ELSE SPACE(0) END)
		+ MAX(CASE WHEN Z.include_column_id = 27 THEN ', [' + Z.GeneralColumn + ']'                                                                     ELSE SPACE(0) END)
		+ MAX(CASE WHEN Z.include_column_id = 28 THEN ', [' + Z.GeneralColumn + ']'                                                                     ELSE SPACE(0) END)
		+ MAX(CASE WHEN Z.include_column_id = 29 THEN ', [' + Z.GeneralColumn + ']'                                                                     ELSE SPACE(0) END)
		+ MAX(CASE WHEN Z.include_column_id = 30 THEN ', [' + Z.GeneralColumn + ']'                                                                     ELSE SPACE(0) END)
		+ MAX(CASE WHEN Z.include_column_id = 31 THEN ', [' + Z.GeneralColumn + ']'                                                                     ELSE SPACE(0) END)
		+ MAX(CASE WHEN Z.include_column_id = 32 THEN ', [' + Z.GeneralColumn + ']'                                                                     ELSE SPACE(0) END)
		+ MAX(CASE WHEN Z.include_column_id = 33 THEN ', [' + Z.GeneralColumn + ']'                                                                     ELSE SPACE(0) END)
		+ MAX(CASE WHEN Z.include_column_id = 34 THEN ', [' + Z.GeneralColumn + ']'                                                                     ELSE SPACE(0) END)
		+ MAX(CASE WHEN Z.include_column_id = 35 THEN ', [' + Z.GeneralColumn + ']'                                                                     ELSE SPACE(0) END)
		+ MAX(CASE WHEN Z.include_column_id = 36 THEN ', [' + Z.GeneralColumn + ']'                                                                     ELSE SPACE(0) END)
		+ MAX(CASE WHEN Z.include_column_id = 37 THEN ', [' + Z.GeneralColumn + ']'                                                                     ELSE SPACE(0) END)
		+ MAX(CASE WHEN Z.include_column_id = 38 THEN ', [' + Z.GeneralColumn + ']'                                                                     ELSE SPACE(0) END)
		+ MAX(CASE WHEN Z.include_column_id = 39 THEN ', [' + Z.GeneralColumn + ']'                                                                     ELSE SPACE(0) END)
		+ MAX(CASE WHEN Z.include_column_id = 40 THEN ', [' + Z.GeneralColumn + ']'                                                                     ELSE SPACE(0) END)
		+ MAX(CASE WHEN Z.include_column_id = 41 THEN ', [' + Z.GeneralColumn + ']'                                                                     ELSE SPACE(0) END)
		+ MAX(CASE WHEN Z.include_column_id = 42 THEN ', [' + Z.GeneralColumn + ']'                                                                     ELSE SPACE(0) END)
		+ MAX(CASE WHEN Z.include_column_id = 43 THEN ', [' + Z.GeneralColumn + ']'                                                                     ELSE SPACE(0) END)
		+ MAX(CASE WHEN Z.include_column_id = 44 THEN ', [' + Z.GeneralColumn + ']'                                                                     ELSE SPACE(0) END)
		+ MAX(CASE WHEN Z.include_column_id = 45 THEN ', [' + Z.GeneralColumn + ']'                                                                     ELSE SPACE(0) END)
		+ MAX(CASE WHEN Z.include_column_id = 46 THEN ', [' + Z.GeneralColumn + ']'                                                                     ELSE SPACE(0) END)
        + MAX(CASE WHEN Z.include_column_id > 46 THEN ', [...]'                                                                                         ELSE SPACE(0) END) AS IncludeColumn
     INTO #Hack
     FROM #ZKey AS Z
...
WHILE @@FETCH_STATUS = 0
    ...
    SET @SQLCode = 'CREATE '
                 ...
                 + CASE WHEN @index_type IN (      5, 6)                             THEN         ' (' + @IncludeColumn + ')'                      ELSE SPACE(00) END
