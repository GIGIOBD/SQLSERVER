...
Com a query abaixo, vou ajudar vocês a identificar possíveis melhores candidatos a índice clustered do que os atuais.
A métrica para identificar isso é através do número de leituras seek entre os índices nonclustered e o clustered. 
Lembre-se que isso é apenas para dar uma ideia do melhor candidato para o índice clustered. 
Você não deve confiar apenas nessa consulta, faça as suas análises!
*/
